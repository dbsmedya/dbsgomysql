...
|---|---|---|
| Oracle MySQL, self-managed or official container images | Supported from 8.0.40 | This repository directly tests the current 8.0, 8.4, and 9.7 lines. Exact resolved versions are recorded in [the version compatibility matrix](mysql-version-specific-compatibility.md). |
