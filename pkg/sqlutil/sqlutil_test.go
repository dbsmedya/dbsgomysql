...
func TestValidateIdentifier(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "leading ASCII space characters", identifier: "\t\n\v\f\r payment"},
		{name: "trailing non-breaking space", identifier: "payment\u00A0"},
		{name: "trailing ideographic space", identifier: "payment\u3000"},
		...
		{name: "trailing TAB", identifier: "payment\t", wantErr: ErrIdentifierTrailingSpace},
		{name: "trailing LF", identifier: "payment\n", wantErr: ErrIdentifierTrailingSpace},
		{name: "trailing VT", identifier: "payment\v", wantErr: ErrIdentifierTrailingSpace},
		{name: "trailing FF", identifier: "payment\f", wantErr: ErrIdentifierTrailingSpace},
		{name: "trailing CR", identifier: "payment\r", wantErr: ErrIdentifierTrailingSpace},
		{name: "trailing SPACE", identifier: "payment ", wantErr: ErrIdentifierTrailingSpace},
		{
			name:       "trailing space character precedes length",
